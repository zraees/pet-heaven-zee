## Summary
- Update README.md. Author: AliSubhani1, branch head → ali/n8n-changes, 1 file/1 commit.
- Top risks (if any): None.

## Detailed Changes (per file)
### README.md — *modified*, +0/-1*. Intent is to remove a line of text from the README file.
```diff
@@ -2,7 +2,6 @@
