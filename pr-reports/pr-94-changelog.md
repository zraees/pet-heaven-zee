## Summary
- Update README.md by AliSubhani1 (branch head → base: ali/n8n-changes, 1 file/1 commit).
- Top risks: None.

## Detailed Changes (per file)
**README.md** — *modified, +1/-1*. The intent is to update the README file with new information.
```diff
@@ -2,7 +2,7 @@
