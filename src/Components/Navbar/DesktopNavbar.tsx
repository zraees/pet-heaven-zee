...
<div className="sm:block hidden">
    ...
    <nav className="flex items-center justify-between px-6 py-16 bg-white shadow-md">
      <div className="ml-[320px] flex space-x-6 z-10">
        <Link to="/" className="font-semibold text-black hover:text-gray-600 cursor-pointer hover:opacity-70">
          Home
        </Link>
        <Link
          to="/contact"
      ...
      <button className="px-6 py-2 text-white-0 font-semibold bg-black-0 rounded-full hover:bg-gray-800">
        Donate Today
      </button>
    </nav>
</div>
